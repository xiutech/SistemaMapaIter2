...
/**
 * Clase para el envío de correos vía GMail.
...
public class SendingMailThroughGmailSMTPServer {
    ...
    /**
     * Envia un correo.
     * @param smtpServerHost el servidor
     * @param smtpServerPort el puerto del servidor
     * @param smtpUserName el nombre de usuario de destinatario
     * @param smtpUserAccessToken el token clave para enviar correos
     * @param fromUserEmail correo del remitente
     * @param fromUserFullName nombre de usuario de remitente
     * @param toEmail el correo de destinatario
     * @param subject el asunto de correo
